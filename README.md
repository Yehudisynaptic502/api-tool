...
3. Download the latest Windows version. The file will usually be named something like `api-tool-setup.exe` or `api-tool.zip`.
...
- If you have a `.zip` file:  
  ...
  - Open the extracted folder and double-click `api-tool.exe` to launch.
